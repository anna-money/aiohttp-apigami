...
- **Built-in Swagger UI**: Ready-to-use interactive documentation (currently <!-- SWAGGER_UI_VERSION_START -->[v5.32.2](https://github.com/swagger-api/swagger-ui/releases/tag/v5.32.2)<!-- SWAGGER_UI_VERSION_END -->)
...
This package includes Swagger UI <!-- SWAGGER_UI_VERSION_START -->[v5.32.2](https://github.com/swagger-api/swagger-ui/releases/tag/v5.32.2)<!-- SWAGGER_UI_VERSION_END -->.
